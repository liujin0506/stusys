...
CREATE TABLE IF NOT EXISTS `think_access` (
  `role_id` smallint(6) unsigned NOT NULL COMMENT '角色(用户组)id',
  `node_id` smallint(6) unsigned NOT NULL COMMENT '节点id',
  `level` tinyint(1) NOT NULL COMMENT '级别',
  `pid` tinyint(6) NOT NULL COMMENT '父类id',
...
CREATE TABLE IF NOT EXISTS `think_node` (
  ...
  `name` varchar(20) NOT NULL COMMENT '角色(用户组)名称',
  `title` varchar(50) DEFAULT NULL COMMENT '英文 名称',
  `status` tinyint(1) DEFAULT '0' COMMENT '状态',
  `remark` varchar(255) DEFAULT NULL COMMENT '描述',
  `sort` smallint(6) unsigned DEFAULT NULL COMMENT '序号',
...
CREATE TABLE IF NOT EXISTS `think_role_user` (
  `role_id` mediumint(9) unsigned DEFAULT NULL COMMENT '角色(用户组)',
